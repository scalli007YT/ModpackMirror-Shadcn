      ...
      <div class="flex flex-col items-stretch px-6 pb-6">
        ...
        <Tabs v-model="selectedTab" default-value="assign" class="w-full">
          <TabsList class="flex w-auto mb-4 gap-2">
            <TabsTrigger value="assign" :class="selectedTab !== 'assign' ? 'cursor-pointer' : ''">Assign</TabsTrigger>
            <TabsTrigger value="files" :class="selectedTab !== 'files' ? 'cursor-pointer' : ''">Files</TabsTrigger>
          </TabsList>
