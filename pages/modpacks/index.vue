  ...
  <div class="flex flex-1 flex-col gap-4 p-4 pt-0">
    ...
    <section>
      <div class="relative w-full max-w-sm items-center">
        <Input id="search" v-model="searchInput" type="text" placeholder="Search..." class="pl-10" />
    ...
    <div class="bg-muted/50 min-h-[100vh] flex-1 rounded-xl md:min-h-min p-2 overflow-hidden">
      ...
      <div v-if="data?.data.length === 0 && !error && !pending" class="flex items-center space-x-4">
